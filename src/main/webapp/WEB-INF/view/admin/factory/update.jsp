...
<body>
    <div class="container mt-5">
        <h1 class="profile-title">Update Factory</h1>
        <form:form action="${pageContext.request.contextPath}/admin/factory/update" method="post" modelAttribute="newFactory" cssClass="mt-4">
