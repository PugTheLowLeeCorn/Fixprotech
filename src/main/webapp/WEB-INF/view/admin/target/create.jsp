...
<body>
    <div class="container mt-5">
        <h1 class="profile-title">Create Target</h1>
        <form:form action="${pageContext.request.contextPath}/admin/target/create" method="post" modelAttribute="newTarget" cssClass="mt-4">
