                                ...
                                <div class="mt-5">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-12 mx-auto">
                                            ...
                                            <form:form method="post" action="/employee/product/delete"
                                                modelAttribute="Product">
                                                <!-- Tạo một form Spring với phương thức POST, action là /employee/product/delete và liên kết đến model attribute "Product". -->
